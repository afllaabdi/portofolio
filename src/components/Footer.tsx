      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="text-xl font-bold text-gradient mb-1">{'<Afllah />'}</p>
            <p className="text-sm text-muted-foreground">{profile.name}</p>
            <p className="text-xs text-muted-foreground/60 mt-1">
              Data Science Student | AI Enthusiast | Software Developer
            </p>
          </div>
          ...
          <motion.button
            onClick={scrollToTop}
            className="p-3 rounded-xl bg-secondary border border-border text-muted-foreground hover:text-foreground hover:border-orange-500/30 transition-all duration-300 cursor-pointer"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <p className="flex items-center gap-1">
            Made with{' '}
            <Heart size={12} className="text-red-500 animate-pulse" /> Next.js,
