...
export default function Contact() {
  ...
  const waUrl = 'https://wa.me/6282180812741?text=Halo%20Afllah,%20saya%20melihat%20portfolio%20Anda%20dan%20tertarik%20untuk%20berdiskusi.'
    ...
    <section id="contact" className="relative py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          >
            <div className="w-full p-8 sm:p-10 rounded-2xl bg-card/80 border border-border">
              {/* WhatsApp Icon */}
              <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500/20 to-amber-500/20 border border-orange-500/20 mb-6">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="#f97316" className="drop-shadow-[0_0_8px_rgba(249,115,22,0.5)]">
              ...
              <div className="text-center mb-2">
                <span className="inline-block px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-semibold tracking-wider uppercase">
                  Chat Langsung
                </span>
              </div>
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm bg-gradient-to-r from-orange-600 to-orange-500 text-white shadow-lg shadow-orange-900/30 hover:shadow-orange-900/50 hover:opacity-90 transition-all duration-300 cursor-pointer"
              ...
              <p className="text-center text-xs text-muted-foreground/60 mt-4">
                Respon cepat • Biasanya membalas dalam hitungan menit
              </p>
            </div>
          </motion.div>
        </div>
